...
def _write_config() -> None:
    ...
    # the TG node — the peer in distributed mode, localhost in single.
    tul = "127.0.0.1" if s.install_type == "single" else s.peer_ip
...
paths:
  ...
  sms_correlation: {DATA_DIR}/sms_correlation.jsonl
"""
